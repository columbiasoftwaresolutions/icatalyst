...
class VizEngine {
  ...
  init() {
    ...
    if (this.scene === 'flow') {
      ...
      // Real-world major + secondary airport hubs — [code, lat°, lon°]
      const HUBS = [
        // North America
        ['JFK', 40.6, -73.8], ['LAX', 33.9, -118.4], ['ORD', 42.0, -87.9],
        ['ATL', 33.6, -84.4], ['DFW', 32.9, -97.0], ['DEN', 39.9, -104.7],
        ['SFO', 37.6, -122.4], ['SEA', 47.4, -122.3], ['MIA', 25.8, -80.3],
        ['BOS', 42.4, -71.0], ['IAD', 38.9, -77.4], ['YYZ', 43.7, -79.6],
        ['YVR', 49.2, -123.2], ['MEX', 19.4, -99.1],
        // South America
        ['GRU', -23.4, -46.5], ['EZE', -34.8, -58.5], ['BOG', 4.7, -74.1],
        ['SCL', -33.4, -70.8], ['LIM', -12.0, -77.1], ['PTY', 9.1, -79.4],
        // Europe
        ['LHR', 51.5, -0.5], ['CDG', 49.0, 2.5], ['FRA', 50.0, 8.6],
        ['AMS', 52.3, 4.8], ['MAD', 40.5, -3.6], ['BCN', 41.3, 2.1],
        ['FCO', 41.8, 12.3], ['MUC', 48.4, 11.8], ['ZRH', 47.5, 8.5],
        ['VIE', 48.1, 16.6], ['CPH', 55.6, 12.6], ['DUB', 53.4, -6.3],
        ['IST', 41.0, 28.8], ['SVO', 55.9, 37.4],
        // Middle East / Africa
        ['DXB', 25.3, 55.4], ['DOH', 25.3, 51.6], ['AUH', 24.4, 54.7],
        ['CAI', 30.1, 31.4], ['TLV', 32.0, 34.9], ['JNB', -26.1, 28.2],
        ['CPT', -33.9, 18.6], ['NBO', -1.3, 36.9], ['ADD', 9.0, 38.8],
        ['LOS', 6.6, 3.3], ['CMN', 33.4, -7.6],
        // Asia
        ['BOM', 19.1, 72.9], ['DEL', 28.6, 77.1], ['BLR', 13.2, 77.7],
        ['MAA', 13.0, 80.2], ['HYD', 17.2, 78.4], ['CCU', 22.6, 88.4],
        ['BKK', 13.7, 100.8], ['KUL', 2.7, 101.7], ['SIN', 1.4, 103.9],
        ['CGK', -6.1, 106.7], ['MNL', 14.5, 121.0], ['HAN', 21.2, 105.8],
        ['SGN', 10.8, 106.7], ['HKG', 22.3, 113.9], ['TPE', 25.1, 121.2],
        ['ICN', 37.5, 126.4], ['NRT', 35.8, 140.4], ['HND', 35.5, 139.8],
        ['KIX', 34.4, 135.2], ['PEK', 40.1, 116.6], ['PVG', 31.1, 121.8],
        ['CAN', 23.4, 113.3], ['CTU', 30.6, 103.9],
        // Oceania
        ['SYD', -33.9, 151.2], ['MEL', -37.7, 144.8], ['BNE', -27.4, 153.1],
