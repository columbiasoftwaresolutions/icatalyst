...
function HomeHero({ t }) {
  ...
  if (centered) {
    return (
      <section style={{ background: 'var(--canvas-dark)', color: 'var(--on-dark)', minHeight: 'calc(100vh - 264px)' }} data-screen-label="Hero">
  ...
  if (layout === 'fullbleed') {
    return (
      <section style={{ background: 'var(--canvas-dark)', color: 'var(--on-dark)', position: 'relative', overflow: 'hidden', minHeight: 'calc(100vh - 264px)' }} data-screen-label="Hero">
...
function PartnerBar() {
  ...
  return (
    <section style={{ background: 'var(--canvas)', borderBottom: '1px solid var(--hairline)' }}>
      ...
      <Container style={{ padding: 'var(--space-2xl) var(--space-3xl) var(--space-3xl)' }}>
        <p className="t-mono-eyebrow" style={{ color: 'var(--body)', textAlign: 'center' }}>TECHNOLOGY PARTNERS</p>
      </Container>
    </section>);
